 ...
 */
DadosMandelbrot* calcular_mandelbrot(int largura, int altura, double x_min, double x_max, 
double y_min, double y_max, int max_iteracoes) {
...
//(Dependência: Python precisa que o C libere isso depois)
    ...
    aplicar_cores_avancadas(dados->pixels, iteracoes, NULL, largura, altura, max_iteracoes);
